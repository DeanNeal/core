...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.Store = exports.Http = exports.Utils = exports.GlobalEvents = exports.TemplateEngine = exports.RouteSwitcher = exports.Router = exports.Component = exports.Register = exports.GlobalData = exports.SmartObject = undefined;
	...
	var GlobalData = new _model.SmartObject();
...
/***/ (function(module, exports, __webpack_require__) {
	...
	function Register(options) {
	    ...
	    _core.GlobalData.set('appIsReady', true);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var RouteSwitcher = exports.RouteSwitcher = function () {
	    function RouteSwitcher(routes, root) {
	        ...
	        _core.GlobalData.sub(function (data) {
	            _this.onCreate();
	        });
	    }
	        ...
	        value: function onCreate() {
	            ...
	            this.routes.forEach(function (route) {
	                _routerCore2.default.on(route.path, function (params) {
	                    if (_this2.prevPage !== route.path) {
	                        // don't refresh parent router
	                        _this2.root.innerHTML = null;
	                        if (params) {
	                            window.temporaryObj = Object.assign({ id: parseInt(params) });
	                        }

	                        var newComp = document.createElement(route.component);
	                        _this2.root.appendChild(newComp);
	                        _this2.prevPage = route.path;
	                    }

	                    var router = _this2.root.querySelectorAll('child-route-switcher')[0];
	                    if (router) {
	                        router.innerHTML = null;
	                        var current = _this2.routes.filter(function (item) {
	                        ...
	                        if (_this2.prevChild !== path || !_this2.prevChild) {
	                            if (child) {
	...
	var Component = exports.Component = function () {
	    ...
	    _createClass(Component, [{
	        ...
	        value: function getComponentVariable(variable, data) {
	            ...
	            return variable.reduce(function (o, i) {
	                return o[i];
	            }, data || this);
	        }
	    }, {
	...
	function _if(array) {
	    ...
	    array.forEach(function (item) {
	        ...
	        conditions = conditions.map(function (res) {
	            ...
	            if (res.indexOf('==') > -1) {
	                var equality = res.replace(/ +/g, "").split('==');
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.Http = exports.Collection = exports.Model = exports.server = undefined;
	...
	var server = exports.server = 'http://tripsee-app.ace-st.com';
	...
	var HttpModule = function () {
	    ...
	    _createClass(HttpModule, [{
	        ...
	        value: function get() {
	            ...
	            this.http.get(server + '/catalog').then(function (res) {
	                return res.json();
	            }).then(function (res) {
	                _this3.catalog.set({ 'entry': _this3.getModel(res) });
	            });
	        }
	    }, {
	        key: 'getModel',
